...
class Query(ObjectType):
    ...
    year= graphene.List(MovieType, year=graphene.Int(), title=graphene.String(),avil=graphene.String()) #get that year

    def resolve_year(selfself,info,**kwargs):
        # print("hitting!!!")
        year = kwargs.get("year")
        title = kwargs.get("title")
        avil = kwargs.get("avil")
        print("title***",title)
        print("avil***",avil)
        if year is not None:
            print("data**",Movie.objects.filter(year=year))
